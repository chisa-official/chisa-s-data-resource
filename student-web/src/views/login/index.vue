  ...
  <div class="login-page">
    <div class="login-page__brand">
      <div class="login-brand">
        ...
        <p class="login-brand__subtitle">学生端</p>
        <p class="login-brand__desc">课程、成绩、学籍、宿舍、通知，一站式学生服务门户</p>
      </div>
    </div>
...
import { studentNoRule } from '@shared-web/utils/validate';
...
.login-page {
  ...
  &__brand {
    ...
    flex: 1;
    padding: $space-7;
    background: linear-gradient(135deg, $brand-primary 0%, #0ea5e9 100%);
    color: $text-inverse;
    overflow: hidden;
