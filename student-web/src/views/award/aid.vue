<template>
  <div class="aid-page">
    <PageHeader title="助学金申请" subtitle="申请助学金，提交后等待学校评审" />
        ...
        <el-card>
          ...
          <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="项目名称" prop="name">
              <el-input v-model="form.name" placeholder="如：国家助学金、校级助学金" maxlength="50" show-word-limit />
            </el-form-item>
