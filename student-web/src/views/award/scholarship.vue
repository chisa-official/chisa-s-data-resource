<template>
  <div class="scholarship-page">
    <PageHeader title="奖学金申请" subtitle="申请校内奖学金，提交后等待学校评审" />
        ...
        <el-card>
          ...
          <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="项目名称" prop="name">
              <el-input v-model="form.name" placeholder="如：国家奖学金、校级一等奖学金" maxlength="50" show-word-limit />
            </el-form-item>
...
const PAGE_TYPE = AwardType.SCHOLARSHIP;
